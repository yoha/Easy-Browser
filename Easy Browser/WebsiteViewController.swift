...
class WebsiteViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Done", style: UIBarButtonItemStyle.Done, target: self, action: "returnToTableView")
        ...
        if let url = NSURL(string: "https://" + self.website) {
    ...
    func webView(webView: WKWebView, decidePolicyForNavigationAction navigationAction: WKNavigationAction, decisionHandler: (WKNavigationActionPolicy) -> Void) {
        ...
        if let host = url.host where host.rangeOfString(self.website) != nil {
